...
public class ejercicio5 {
    ...
    public static int[] randomUno(int n) { //n=4 --> [0,1,2,3]
        ...
        for (i = 0; i < n; i++) { // for(i=0;i<4;i++)
            ...
            while (seguirBuscando) {
                x = ran_int(0,n-1); //x=random desde 0 hasta 3
    ...
    System.out.println(Arrays.toString(randomUno(4)));
    System.out.println(Arrays.toString(randomDos(4)));
    System.out.println(Arrays.toString(randomTres(4)));
    }
}